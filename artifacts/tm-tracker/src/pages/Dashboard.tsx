...
function MetricCard({
  ...
  return (
    <div
      className={`border-2 border-[#0C0C0C] p-3 sm:p-3.5 flex flex-col justify-between shadow-[2px_2px_0_#0C0C0C] min-h-[90px] ${colorClass}`}
    >
      <div>
        <div className="font-mono text-[10px] sm:text-[11px] font-bold uppercase tracking-wider opacity-90 truncate">
          {label}
        </div>
      </div>
      <div className="mt-1">
        ...
        {subLabel && (
          <div className="font-mono text-[9px] uppercase tracking-widest opacity-80 mt-1 truncate">
            {subLabel}
          </div>
        )}
      </div>
...
function QuickAction({
  ...
  return (
    <Link
      href={href}
      className={`flex items-center justify-between p-3 sm:p-3.5 border-2 border-[#0C0C0C] font-mono font-bold text-xs uppercase tracking-wider transition-all shadow-[3px_3px_0_#0C0C0C] hover:-translate-y-0.5 hover:shadow-[5px_5px_0_#0C0C0C] active:translate-y-0 active:shadow-none ${color}`}
    >
    ...
    <AppShell>
      <div className="flex-1 overflow-auto bg-[#F0E8D0] p-4 sm:p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          {/* ── A. BRAND & HEADER AREA ────────────────────────────────────────── */}
          <div className="border-b-2 border-[#0C0C0C] pb-5 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              {/* Status context pill */}
              <div className="inline-flex items-center gap-2 self-start sm:self-auto bg-white border-2 border-[#0C0C0C] px-3 py-1.5 shadow-[2px_2px_0_#0C0C0C]">
                <div className="w-2 h-2 rounded-full bg-[#0D9970] animate-pulse" />
                <span className="font-mono text-[10px] font-bold uppercase tracking-wider text-[#0C0C0C]">
                  LIVE REGISTRY DATA
                </span>
              </div>
            </div>
            ...
            <div className="bg-[#E8DFC7] border-2 border-[#0C0C0C] p-3 sm:p-4 flex flex-wrap items-center justify-between gap-3 shadow-[3px_3px_0_#0C0C0C]">
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                <div className="flex items-center gap-1.5 font-mono text-xs font-bold text-[#0C0C0C] uppercase tracking-wider">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <select
                    ...
                    className="h-9 px-3 bg-white border-2 border-[#0C0C0C] font-mono text-xs font-medium text-[#0C0C0C] focus:outline-2 focus:outline-[#6C1C1F] cursor-pointer"
                  >
                ...
                {hasActiveFilters && (
                  <button
                    ...
                    className="flex items-center gap-1 h-9 px-3 bg-white border-2 border-[#CC0000] text-[#CC0000] font-mono font-bold text-xs uppercase tracking-wider hover:bg-[#CC0000] hover:text-white transition-colors"
                  >
              ...
              {hasActiveFilters && (
                <div className="flex items-center gap-2 font-mono text-[10px] font-bold text-[#6C1C1F]">
          ...
          {isLoadingStats ? (
            <div className="p-8 border-2 border-[#0C0C0C] bg-white text-center font-mono font-bold text-[#6d6658] space-y-2 animate-pulse shadow-[4px_4px_0_#0C0C0C]">
              <div className="text-sm uppercase tracking-widest">LOADING LIVE DATABASE METRICS...</div>
              <div className="text-xs opacity-75">Querying verified Supabase registry records</div>
            </div>
          ) : isStatsError || !stats ? (
            <div className="p-6 border-2 border-[#CC0000] bg-white text-[#CC0000] font-mono font-bold flex flex-col sm:flex-row items-center justify-between gap-4 shadow-[4px_4px_0_#0C0C0C]">
              <div className="flex items-center gap-3">
                <AlertCircle className="w-6 h-6 shrink-0" />
                <div>
                  <div className="text-sm uppercase tracking-wider">FAILED TO LOAD DATABASE METRICS</div>
                  <div className="text-xs font-normal text-[#0C0C0C] mt-0.5">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#CC0000] text-white border-2 border-[#0C0C0C] font-mono font-bold text-xs uppercase tracking-wider hover:brightness-110"
              >
                RETRY QUERY
              </button>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="border-2 border-[#0C0C0C] bg-white shadow-[4px_4px_0_#0C0C0C]">
                    <div className="px-4 py-3 border-b-2 border-[#0C0C0C] bg-[#E8DFC7] flex flex-wrap items-center justify-between gap-2">
                      ...
                      <span className="font-mono text-[10px] font-bold text-[#6d6658] uppercase tracking-wider bg-white px-2 py-0.5 border border-[#0C0C0C]/20">
                          ...
                          <div key={stageKey} className="space-y-1.5">
                            <div className="flex items-center justify-between text-xs font-mono">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[#6d6658] hidden sm:inline text-[11px]">
                                  · {config.subLabel}
                                </span>
                              </div>
                              ...
                              <div className="flex items-center gap-2 font-bold shrink-0">
                                ...
                                <span className="text-[10px] text-[#6d6658] bg-[#F0E8D0] px-1.5 py-0.5 border border-[#0C0C0C]/15 min-w-[42px] text-right">
                                  {percentage}%
                                </span>
                              </div>
                            </div>
                    ...
                    <div className="px-4 py-2.5 border-t-2 border-[#0C0C0C] bg-[#FFF9F0] flex items-center justify-between font-mono text-[10px] text-[#6d6658]">
                  ...
                  <div className="border-2 border-[#0C0C0C] bg-white shadow-[4px_4px_0_#0C0C0C]">
                    ...
                    <div className="px-4 py-2 border-t-2 border-[#0C0C0C] bg-[#FFF9F0] font-mono text-[10px] text-[#6d6658]">
                  ...
                  <div className="border-2 border-[#0C0C0C] bg-white shadow-[4px_4px_0_#0C0C0C]">
                    <div className="px-4 py-3 border-b-2 border-[#0C0C0C] bg-[#E8DFC7] flex items-center justify-between">
                      ...
                      <span className="font-mono text-[10px] font-bold text-[#6d6658] uppercase">
                    ...
                    <div className="p-4 sm:p-5">
                      {stats.byCity.length === 0 ? (
                        <div className="font-mono text-xs text-[#6d6658] py-4 text-center">
                              ...
                              return (
                                ...
                                >
                                  <div className="truncate pr-2">
                                    <div className="text-[11px] font-bold text-[#0C0C0C] uppercase truncate">
                                      {c.city || "UNSPECIFIED"}
                                    </div>
                                    <div className="text-[9px] text-[#6d6658]">{cityPct}% of total</div>
                                  </div>
                ...
                <div className="lg:col-span-4 space-y-6">
                  {/* ── G. QUICK ACTIONS ──────────────────────────────────────── */}
                  <div className="border-2 border-[#0C0C0C] bg-white shadow-[4px_4px_0_#0C0C0C]">
                    <div className="px-4 py-3 border-b-2 border-[#0C0C0C] bg-[#E8DFC7] font-mono font-bold text-xs uppercase tracking-wider text-[#0C0C0C]">
                      QUICK ACTIONS
                    </div>
                  ...
                  <div className="border-2 border-[#0C0C0C] bg-white shadow-[4px_4px_0_#0C0C0C]">
                    <div className="px-4 py-3 border-b-2 border-[#0C0C0C] bg-[#E8DFC7] font-mono font-bold text-xs uppercase tracking-wider flex items-center justify-between text-[#0C0C0C]">
                      <div className="flex items-center gap-2">
                        <Clock className="w-4 h-4 text-[#6C1C1F]" />
                        <span>RECENT ACTIVITY</span>
                      </div>
                      <span className="font-mono text-[10px] font-bold text-[#6d6658]">LAST 10 EVENTS</span>
                    </div>

                    <div>
                      {isLoadingActivity ? (
                        <div className="p-6 font-mono text-xs text-[#6d6658] text-center animate-pulse">
                          LOADING ACTIVITY FEED...
                        </div>
                      ) : recentActivity.length === 0 ? (
                        <div className="p-6 font-mono text-xs text-[#6d6658] text-center">
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-center justify-between gap-2">
                                  <span
                                    className={`font-mono text-[9px] font-bold px-1.5 py-0.5 border uppercase ${badgeStyle}`}
                                  >
                                    {log.action}
                                  </span>
                                ...
                                <div className="font-mono text-xs font-bold text-[#0C0C0C]">
                                  {log.recordId ? (
                                    <Link
                                ...
                                {(log.applicationName || log.clientCode) && (
                                  <div className="font-mono text-[10px] text-[#0C0C0C]/80 truncate">
                                ...
                                <div className="font-mono text-[9px] text-[#6d6658] pt-0.5 flex items-center justify-between">
                                  <span>by {shortUser(log.changedBy)}</span>
                                  {log.caseType && (
                                    <span className="uppercase text-[8px] bg-black/5 px-1 rounded-xs">
                                      {log.caseType}
                                    </span>
                                  )}
                                </div>
                    ...
                    <Link
                      href="/logs"
                      className="block text-center border-t-2 border-[#0C0C0C] bg-[#F0E8D0] py-2.5 font-mono text-[10px] font-bold uppercase tracking-widest text-[#0C0C0C] hover:bg-[#0C0C0C] hover:text-[#F0E8D0] transition-colors"
                    >
                      VIEW ALL AUDIT LOGS →
                    </Link>
                  </div>
